...
<div class="sff-meal-plan-preview">
    ...
    <div class="sff-calendar-grid">
        <?php foreach ($calendar_days as $day_key => $day_data) :
            ...
            $day_label       = isset($day_data['label']) ? $day_data['label'] : '';
            $day_short_label = isset($day_data['short_label']) ? $day_data['short_label'] : (function_exists('mb_substr') ? mb_substr($day_label, 0, 1) : substr($day_label, 0, 1));
            ?>
            <div
            ...
            >
                <div class="sff-calendar-day__header">
                    <div class="sff-calendar-day__heading">
                        <span class="sff-calendar-day__title" aria-hidden="true"><?php echo esc_html($day_short_label); ?></span>
                        <span class="screen-reader-text"><?php echo esc_html($day_label); ?></span>
                        ...
                        <?php foreach ($recipes as $recipe) :
                            ...
                            <article class="sff-preview-meal" data-recipe-id="<?php echo esc_attr($recipe['id']); ?>" data-calories="<?php echo esc_attr($macros['calories']); ?>" data-protein="<?php echo esc_attr($macros['protein']); ?>" data-carbs="<?php echo esc_attr($macros['carbs']); ?>" data-fat="<?php echo esc_attr($macros['fat']); ?>" data-day="<?php echo esc_attr($day_key); ?>" data-time-label="<?php echo esc_attr($recipe['time_label']); ?>" draggable="true" role="button" tabindex="0" aria-haspopup="dialog" aria-expanded="false">
                                ...
                                <div class="sff-preview-meal__drawer" data-recipe-panel hidden>
                                    <div class="sff-preview-meal__drawer-header">
                                        <h4 class="sff-preview-meal__drawer-title"><?php echo esc_html($recipe['title']); ?></h4>
                                        <p class="sff-preview-meal__drawer-subtitle"><?php esc_html_e('Review ingredients and swap anything that needs to change.', 'simplified-food-fitness'); ?></p>
                                    </div>
                                    <div class="sff-preview-meal__drawer-content">
                                        ...
                                        <div class="sff-preview-meal__editor">
    ...
    <div class="sff-meal-plan-preview__modal" role="dialog" aria-modal="true" aria-hidden="true">
        <div class="sff-meal-plan-preview__modal-backdrop" data-modal-close="true"></div>
        <div class="sff-meal-plan-preview__modal-panel" role="document">
            <button type="button" class="sff-meal-plan-preview__modal-close" aria-label="<?php esc_attr_e('Close recipe customization', 'simplified-food-fitness'); ?>">
                <span aria-hidden="true">&times;</span>
            </button>
            <div class="sff-meal-plan-preview__modal-content"></div>
        </div>
    </div>
