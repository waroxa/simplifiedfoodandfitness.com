...
<div id="macro-result" class="sff-lead-section" style="margin-top: 30px; display: none; font-family:'Segoe UI', Arial, sans-serif;">
 ...
 <!--    <div style="text-align:center; margin-top: 30px;">
  ...
  <!-- outside the hidden macro-result block -->
...
<!-- ✅ Force-load jQuery manually (WordPress fallback + CDN backup) -->
...
<!-- ✅ Force-load your plugin's JS -->
<script src="<?php echo SFF_PLUGIN_URL . 'assets/js/sff-scripts.js?ver=1.0.0'; ?>"></script>

<!-- ✅ Make sure sff_ajax_obj exists -->
<script>
  var sff_ajax_obj = {
    ajax_url: "<?php echo admin_url('admin-ajax.php'); ?>",
    nonce: "<?php echo wp_create_nonce('sff_scan_nonce'); ?>"
  };
</script>

<script>
  console.log("🧪 TEST: jQuery loaded?", typeof jQuery);
</script>
