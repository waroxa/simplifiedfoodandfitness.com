...
"use strict";
/*!*******************************************************!*\
  !*** ./wp-content/plugins/helper/js/source/exp.js ***!
  \*******************************************************/
...
( function ( $ ) {
    ...
    $( document ).ready( function () {
        ...
        const { ajaxURL, nonce } = mdpHelperUnity;
            ...
            $exportButton.addEventListener('click', (e) => {
                ...
                xhr.onload = () => {
                    ...
                    if (xhr.status === 200) {
                        ...
                        // Download file
                        let fileName = 'helper-settings.json'
                ...
                xhr.send(`action=export_settings_helper&nonce=${nonce}`);
        ...
        function readFile( file ) {
            ...
            reader.onload = ( function( theFile ) {
                ...
                return function( e ) {
                    ...
                    xhr.send(`action=import_settings_helper&nonce=${ nonce }&import=${ encodeURIComponent( JSON.stringify( json ) ) }`);
