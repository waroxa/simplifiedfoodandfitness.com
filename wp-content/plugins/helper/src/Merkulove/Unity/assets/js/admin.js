...
( function ( $ ) {
    ...
    $( document ).ready( function () {
        ...
        let mdpHelper = window.mdpHelperUnity;
        ...
        $subscribeBtn.on( 'click', function (e) {
            ...
            if ( $mail.val().length > 0 && window.MerkulovMaterial[mailIndex].valid) {
                ...
                $.ajax({
                    type: "GET",
                    url: `${ mdpHelper.restBase }helper/v2/subscribe`,
                    crossDomain: true,
        ...
        $checkUpdatesBtn.on( 'click', function ( e ) {
            ...
            let data = {
                action: 'check_updates_helper',
                nonce: mdpHelper.nonce,
                checkUpdates: true
            };

            /** Do AJAX request. */
            $.post( mdpHelper.ajaxURL, data, function( response ) {
         ...
         * @param pid
         *
         * @param window.mdpHelperUnity.translation.pidErrorElements
         * @param window.mdpHelperUnity.translation.pidErrorInvoice
         * @param window.mdpHelperUnity.translation.pidErrorOrder
         * @param window.mdpHelperUnity.translation.pidError
         * @returns {boolean}
         */
        function pidValidator( $helper, pid ) {
            ...
            const { translation } = window.mdpHelperUnity;
