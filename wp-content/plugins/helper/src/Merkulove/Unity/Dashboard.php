...
final class Dashboard {
		...
		if ( 'dashboard' === $screen->base ) {
			...
			wp_localize_script(
				...
				[
                    ...
                    'translation' => array(
                        'licenseActive'     => esc_html__( 'Licensed', 'helper' ),
                        'licenseInactive'   => esc_html__( 'No license', 'helper' ),
                        'licenseUnknown'    => esc_html__( 'No licence data', 'helper' ),
                        'wait'              => esc_html__( 'Wait', 'helper' ),
                    )
				]
			);
	...
	public function unity_dashboard_setup() {
		...
		wp_add_dashboard_widget(
			...
			esc_html__( 'Plugins Manager', 'helper' ),
	...
	private function header_markup( ): string {
		...
		return wp_sprintf(
            ...
            esc_html__( 'Explore more plugins', 'helper' ),
			esc_html__( 'opens in a new window', 'helper' )
		);
    ...
    private function plugin_status_markup( $slug, $plugin ): string {
        ...
        $license_status = wp_sprintf(
	        ...
	        esc_html__( 'Plugin licence status', 'helper' )
        );
        ...
        $update_status = wp_sprintf(
	        ...
	        esc_html__( 'Update to', 'helper' ),
	        esc_html__( 'Latest', 'helper' ),
