...
abstract class Tab {
    ...
    protected function do_settings_base( $tab_slug = null ) {
        ...
        settings_fields( 'Helper' . $tab_slug . 'OptionsGroup' );
        do_settings_sections( 'Helper' . $tab_slug. 'OptionsGroup' );
    ...
    protected function add_settings_base( $tab_slug = null ) {
        ...
        /** Status Tab. */
        register_setting( 'Helper' . $tab_slug . 'OptionsGroup', 'mdp_helper_' . $tab_slug . '_settings' );
        add_settings_section( 'mdp_helper_' . $tab_slug . '_page_status_section', '', null, 'Helper' . $tab_slug . 'OptionsGroup' );
    ...
    public static function add_settings_tab(
        ...
        $new_tab = array(
            'enabled'       => true,
            'class'         => $class,
            'label'         => $label ?? esc_html__( 'Tab', 'helper' ),
            'title'         => $title ?? esc_html__( 'Tab', 'helper' ),
