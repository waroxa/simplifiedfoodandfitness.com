...
final class ReporterWordPress {
	...
	public function get_title() {
        ...
        return esc_html__( 'WordPress Environment', 'helper' );
	...
	public function get_fields() {
		...
		return [
			'version'               => esc_html__( 'Version', 'helper' ),
			'site_url'              => esc_html__( 'Site URL', 'helper' ),
			'home_url'              => esc_html__( 'Home URL', 'helper' ),
			'is_multisite'          => esc_html__( 'WP Multisite', 'helper' ),
			'max_upload_size'       => esc_html__( 'Max Upload Size', 'helper' ),
			'memory_limit'          => esc_html__( 'Memory limit', 'helper' ),
			'permalink_structure'   => esc_html__( 'Permalink Structure', 'helper' ),
			'language'              => esc_html__( 'Language', 'helper' ),
			'timezone'              => esc_html__( 'Timezone', 'helper' ),
			'admin_email'           => esc_html__( 'Admin Email', 'helper' ),
			'debug_mode'            => esc_html__( 'Debug Mode', 'helper' ),
		];
	...
	public function get_memory_limit() {
		...
		if ( $memory_limit_bytes < $min_recommended_bytes ) {
			$result['recommendation'] = esc_html__( 'We recommend setting memory to at least 64M. For more information, ask your hosting provider.', 'helper' );
	...
	public function get_is_multisite() {
		...
		return [
			'value' => is_multisite() ? esc_html__( 'Yes', 'helper' ) : esc_html__( 'No', 'helper' )
		];
	...
	public function get_permalink_structure() {
		...
		if ( ! $structure ) {
			$structure = esc_html__( 'Plain', 'helper' );
		}
	...
	public function get_debug_mode() {
		...
		return [
			'value' => WP_DEBUG ? esc_html__( 'Active', 'helper' ) : esc_html__( 'Inactive', 'helper' )
		];
