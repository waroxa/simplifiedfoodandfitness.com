...
final class TabGeneral extends Tab {
	...
	public function add_settings( $tab_slug ) {
        ...
        $group = 'Helper' . $tab_slug . 'OptionsGroup';
        $section = 'mdp_helper_' . $tab_slug . '_page_status_section';
	...
	public function create_field( $args = [] ) {
        ...
        if ( ! is_callable( [ $this, 'render_' . $args[ 'type' ] ] ) ) {
            ?><div class="mdc-system-warn"><?php esc_html_e( 'Handler for this field type not found.', 'helper' ); ?></div><?php
            return;
        }
    ...
    public function prepare_attr( $key, $tab_slug, $field ) {
        ...
        $name = 'mdp_helper_' . $tab_slug . '_settings';
