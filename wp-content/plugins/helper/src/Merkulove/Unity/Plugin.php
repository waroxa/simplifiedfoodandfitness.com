...
final class Plugin {
    ...
    private function initialization() {
        ...
        /** Full path to main plugin file. */
        self::$plugin_file = dirname( dirname( dirname( __DIR__ ) ) ) . '/helper.php';
        ...
        if ( in_array( self::$type, [ 'elementor', 'wpbakery' ] ) ) {
            ...
            self::$menu_bases[] = 'appearance_page_mdp_helper_settings';
            self::$menu_bases[] = 'elementor_page_mdp_helper_settings';
            self::$menu_bases[] = 'settings_page_mdp_helper_settings';

        /** For general WordPress plugins. */
        } else {

            self::$menu_bases[] = 'toplevel_page_mdp_helper_settings';
            self::$menu_bases[] = 'helper_page_mdp_helper_settings';
    ...
    private function add_general_tab() {
        ...
        self::$tabs['general'] = [
            ...
            'label'         => esc_html__( 'General', 'helper' ),
            'title'         => esc_html__( 'General Settings', 'helper' ),
            'show_title'    => true,
            'icon'          => 'tune',
            'fields'        => []
        ];
    ...
    private function add_custom_css_tab() {
        ...
        self::$tabs['custom_css'] = [
            ...
            'label'         => esc_html__( 'Custom CSS', 'helper' ),
            'title'         => esc_html__( 'Custom CSS', 'helper' ),
            'show_title'    => true,
            'icon'          => 'code',
            'fields'        => [
                'custom_css' => [
                    'type'              => 'css_editor',
                    'description'       => esc_html__( 'Add custom CSS here.', 'helper' ),
    ...
    private function add_assignments_tab() {
        ...
        self::$tabs['assignments'] = [
            ...
            'label'         => esc_html__( 'Assignments', 'helper' ),
            'title'         => esc_html__( 'Assignments Settings', 'helper' ),
            'show_title'    => true,
            'icon'          => 'flag',
            'assignments'   => [
    ...
    private function add_activation_tab() {
        ...
        self::$tabs['activation'] = [
            ...
            'label'         => esc_html__( 'Activation', 'helper' ),
            'title'         => esc_html__( 'Plugin Activation', 'helper' ),
            'show_title'    => false,
            'icon'          => 'vpn_key',
            'fields'        => [
    ...
    private function add_status_tab() {
        ...
        self::$tabs['status'] = [
            ...
            'label'         => esc_html__( 'Status', 'helper' ),
            'title'         => esc_html__( 'System Status', 'helper' ),
            'show_title'    => true,
    ...
    private function add_updates_tab() {
        ...
        self::$tabs['updates'] = [
            ...
            'label'         => esc_html__( 'Updates', 'helper' ),
            'title'         => esc_html__( 'Updates', 'helper' ),
            'show_title'    => true,
            'icon'          => 'update',
            'fields'        => [
                'check_ssl' => [
    ...
    private function add_migration_tab() {
        ...
        self::$tabs['migration'] = [
            ...
            'label'         => esc_html__( 'Migration', 'helper' ),
            'title'         => esc_html__( 'Migration Settings', 'helper' ),
            'show_title'    => true,
            'icon'          => 'multiple_stop',
            'fields'        => [
                'delete_plugin' => [
                    'type'              => 'select',
                    'options'           => [
                        'plugin'                => esc_html__( 'Delete plugin only', 'helper' ),
                        'plugin+settings'       => esc_html__( 'Delete plugin and settings', 'helper' ),
                        'plugin+settings+data'  => esc_html__( 'Delete plugin, settings and data', 'helper' ),
                    ],
                    'default'           => 'plugin',
                ]
            ]
    ...
    public static function get_plugin_file() {
        ...
        return dirname( dirname( dirname( __DIR__ ) ) ) . '/helper.php';
