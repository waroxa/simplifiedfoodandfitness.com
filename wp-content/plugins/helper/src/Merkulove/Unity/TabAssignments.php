...
final class TabAssignments extends Tab  {
	...
	public function add_admin_scripts() {
        ...
        wp_enqueue_script( 'mdp-helper-assignments', Plugin::get_url() . 'src/Merkulove/Unity/assets/js/assignments' . Plugin::get_suffix() . '.js', [ 'jquery-datetimepicker-full', 'jquery' ], Plugin::get_version(), true );
	...
	public function render_assignments() {
        ...
        <input type='hidden'
               id="mdp-assignInput"
               name='<?php echo esc_attr( 'mdp_helper_' . self::TAB_SLUG . '_settings' ); ?>[assignments]'
        ...
        <div id="mdp-assign-box">
            ...
            <div class="mdp-all-fields">
                ...
                <div class="mdp-panel mdp-panel-box mdp-matching-method mdp-margin <?php $this->is_need_to_hide( 'matching_method' ); ?>">
                    <h4><?php esc_html_e( 'Matching Method', 'helper' ); ?></h4>
                    <p><?php esc_html_e( 'Should all or any assignments be matched?', 'helper' ); ?></p>
                    <div class="mdp-button-group mdp-button-group mdp-matchingMethod" data-mdp-button-radio="">
                        <button class="mdp-button mdp-button-success mdp-button-small mdp-all mdp-active"><?php esc_html_e( 'ALL', 'helper' ); ?></button>
                        <button class="mdp-button mdp-button-success mdp-button-small mdp-any"><?php esc_html_e( 'ANY', 'helper' ); ?></button>
                    </div>
	                <p><?php esc_html_e('The plugin is enabled on the page if ALL the selected rules matched, or if ANY of the selected rules matched', 'helper' ); ?></p>
                </div>

                <div class="mdp-panel mdp-panel-box mdp-wp-content mdp-margin <?php $this->is_need_to_hide( 'wordpress_content' ); ?>">

                    <h4><?php esc_html_e( 'WordPress Content', 'helper' ); ?></h4>

                    <div class="mdp-button-group mdp-button-group" data-mdp-button-radio="">
                        <button class="mdp-button mdp-button-primary mdp-button-small mdp-ignore mdp-active"><?php esc_html_e( 'Ignore', 'helper' ); ?></button>
                        <button class="mdp-button mdp-button-success mdp-button-small mdp-include"><?php esc_html_e( 'Include', 'helper' ); ?></button>
                        <button class="mdp-button mdp-button-danger mdp-button-small mdp-exclude"><?php esc_html_e( 'Exclude', 'helper' ); ?></button>
                    </div>

                    <div class="mdp-wp-content-box">
                        <p class="mdp-margin-bottom-remove mdp-margin-top">
							<?php esc_html_e( 'Select on what page types or categories the assignment should be active.', 'helper' ); ?>
                        </p>
                        <label>
                ...
                <div class="mdp-panel mdp-panel-box mdp-home-page mdp-margin <?php $this->is_need_to_hide( 'home_page' ); ?>">
                    ...
                    <h4><?php esc_html_e( 'Home Page', 'helper' ); ?></h4>
                ...
                <div class="mdp-panel mdp-panel-box mdp-menu-items mdp-margin <?php $this->is_need_to_hide( 'menu_items' ); ?>">
                    <h4><?php esc_html_e( 'Menu Items', 'helper' ); ?></h4>
                    <div class="mdp-button-group mdp-button-group" data-mdp-button-radio="">
                        <button class="mdp-button mdp-button-primary mdp-button-small mdp-ignore mdp-active"><?php esc_html_e( 'Ignore', 'helper' ); ?></button>
                        <button class="mdp-button mdp-button-success mdp-button-small mdp-include"><?php esc_html_e( 'Include', 'helper' ); ?></button>
                        <button class="mdp-button mdp-button-danger mdp-button-small mdp-exclude"><?php esc_html_e( 'Exclude', 'helper' ); ?></button>
                    ...
                    <div class="mdp-menuitems-selection">
                        <p class="mdp-margin-bottom-remove mdp-margin-top"><?php esc_html_e( 'Select the menu items to assign to.', 'helper' ); ?></p>
                        <label>
                ...
                <div class="mdp-panel mdp-panel-box mdp-date-time mdp-margin <?php $this->is_need_to_hide( 'date_time' ); ?>">
                    ...
                    <h4><?php esc_html_e( 'Date & Time', 'helper' ); ?></h4>
                    ...
                    <div class="mdp-period-picker-box">
                        ...
                        <p>
							<?php esc_html_e( 'The date and time assignments use the date/time of your servers, not that of the visitors system.', 'helper' ); ?>
                            <br>
							<?php esc_html_e( 'Current date/time:', 'helper' ); ?>
                ...
                <div class="mdp-panel mdp-panel-box mdp-languages mdp-margin <?php $this->is_need_to_hide( 'languages' ); ?>">
                    ...
                    <h4><?php esc_html_e( 'Languages', 'helper' ); ?></h4>
                    ...
                    <div class="languages-box">
                        <p class="mdp-margin-remove-bottom mdp-margin-top"><?php esc_html_e( 'Select the languages to assign to.', 'helper' ); ?></p>
                        ...
                        <select class="languages chosen-select" multiple="">
                            ...
                            foreach ( $translations as $key => $language ) :
                                ?><option value="<?php echo esc_attr( $key ); ?>"><?php echo esc_html( $language['native_name'] ); ?></option><?php
                            endforeach; ?>
                        </select>
                    </div>
                ...
                <div class="mdp-panel mdp-panel-box mdp-user-roles mdp-margin <?php $this->is_need_to_hide( 'user_roles' ); ?>">
                    ...
                    <h4><?php esc_html_e( 'User Roles', 'helper' ); ?></h4>
                    ...
                    <div class="user-roles-box">
                        <p class="mdp-margin-remove-bottom mdp-margin-top"><?php esc_html_e( 'Select the user roles to assign to.', 'helper' ); ?></p>
                        <label>
                ...
                <div class="mdp-panel mdp-panel-box mdp-url mdp-margin <?php $this->is_need_to_hide( 'url' ); ?>">
                    ...
                    <h4><?php esc_html_e( 'URL', 'helper' ); ?></h4>
                    ...
                    <div class="mdp-url-box">
                        <p class="mdp-margin-bottom-remove mdp-margin-top">
							<?php esc_html_e( 'Enter (part of) the URLs to match.', 'helper' ); ?><br>
							<?php esc_html_e( 'Use a new line for each different match.', 'helper' ); ?>
                        </p>
                ...
                <div class="mdp-panel mdp-panel-box mdp-devices mdp-margin <?php $this->is_need_to_hide( 'devices' ); ?>">
                    ...
                    <h4><?php esc_html_e( 'Devices', 'helper' ); ?></h4>
                    ...
                    <div class="mdp-devices-box">
                        <p class="mdp-margin-remove-bottom mdp-margin-top"><?php esc_html_e( 'Select the devices to assign to. Keep in mind that device detection is not always 100% accurate. Users can setup their device to mimic other devices.', 'helper' ); ?></p>
                        <label>
                        <select class="devices chosen-select" multiple="">
                            <option value=""></option>
                            <option value="desktop"><?php esc_html_e( 'Desktop', 'helper' ); ?></option>
                            <option value="tablet"><?php esc_html_e( 'Tablet', 'helper' ); ?></option>
                            <option value="mobile"><?php esc_html_e( 'Mobile', 'helper' ); ?></option>
                        </select>
                        </label>
                    </div>
                ...
                <div class="mdp-panel mdp-panel-box mdp-os mdp-margin <?php $this->is_need_to_hide( 'operating_systems' ); ?>">
                    ...
                    <h4><?php esc_html_e( 'Operating Systems', 'helper' ); ?></h4>
                    ...
                    <div class="mdp-os-box">
                        <p class="mdp-margin-remove-bottom mdp-margin-top"><?php esc_html_e( 'Select the operating systems to assign to. Keep in mind that operating system detection is not always 100% accurate. Users can setup their browser to mimic other operating systems.', 'helper' ); ?></p>
                        <!--suppress HtmlFormInputWithoutLabel -->
                ...
                <div class="mdp-panel mdp-panel-box mdp-browsers mdp-margin <?php $this->is_need_to_hide( 'browsers' ); ?>">
                    ...
                    <h4><?php esc_html_e( 'Browsers', 'helper' ); ?></h4>
                    ...
                    <div class="mdp-browsers-box">
                        <p class="mdp-margin-remove-bottom mdp-margin-top"><?php esc_html_e( 'Select the browsers to assign to. Keep in mind that browser detection is not always 100% accurate. Users can setup their browser to mimic other browsers.', 'helper' ); ?></p>

                        <div class="mdp-widget-manager-control-box">
                            <p><?php esc_html_e( 'Browsers', 'helper' ); ?>:</p>
                            <div>
                                <!--suppress HtmlFormInputWithoutLabel -->
                                <select class="browsers chosen-select" multiple="">
                                    <option value=""></option>
                                    <option value="Chrome"><?php echo esc_attr( 'Chrome' ); ?> (<?php esc_html_e( 'All', 'helper' ); ?>)</option>
                                    ...
                                    <option value="Firefox"><?php echo esc_attr( 'Firefox' ); ?> (<?php esc_html_e( 'All', 'helper' ); ?>)</option>
                                    ...
                                    <option value="MSIE"><?php echo esc_attr( 'Internet Explorer' ); ?> (<?php esc_html_e( 'All', 'helper' ); ?>)</option>
                                    ...
                                    <option value="Opera"><?php echo esc_attr( 'Opera' ); ?> (<?php esc_html_e( 'All', 'helper' ); ?>)</option>
                                    ...
                                    <option value="Safari"><?php echo esc_attr( 'Safari' ); ?> (<?php esc_html_e( 'All', 'helper' ); ?>)</option>
                        ...
                        <div class="mdp-widget-manager-control-box">
                            <p><?php esc_html_e( 'Mobile Browsers:', 'helper' ); ?></p>
                            <div>
                                <!--suppress HtmlFormInputWithoutLabel -->
                                <select class="mobile-browsers chosen-select" multiple="">
                                    <option value=""></option>
                                    <option value="mobile"><?php esc_html_e( 'All', 'helper' ); ?></option>
                ...
                <div class="mdp-panel mdp-panel-box mdp-ips mdp-margin <?php $this->is_need_to_hide( 'ip_addresses' ); ?>">
                    ...
                    <h4><?php esc_html_e( 'IP Addresses', 'helper' ); ?></h4>
                    ...
                    <div class="mdp-ips-box">
                        <p class="mdp-margin-bottom-remove mdp-margin-top">
                            <?php esc_html_e( 'IP Addresses / Ranges', 'helper' ); ?><br>
                        </p>

                        <!--suppress HtmlFormInputWithoutLabel -->
                        <textarea class="mdp-ips-field"></textarea>
                        <p>
                            <?php esc_html_e( 'List of IP addresses or IP ranges. Example: ', 'helper' ); ?><br>
                ...
                <div class="mdp-panel mdp-panel-box mdp-php mdp-margin <?php $this->is_need_to_hide( 'custom_php' ); ?>">
                    ...
                    <h4><?php esc_html_e( 'Custom PHP', 'helper' ); ?></h4>
                    ...
                    <div class="mdp-php-box">
                        <p class="mdp-margin-bottom-remove mdp-margin-top">
							<?php esc_html_e( 'Enter a piece of PHP code to evaluate. The code must return the value true or false.', 'helper' ); ?>
                            <br>
							<?php esc_html_e( 'For instance:', 'helper' ); ?>
                        </p>
...
return $result;</pre>
                ...
                <p><?php esc_html_e( 'By selecting the specific assignments you can limit where plugin should or shouldn\'t be published. To have it published on all pages, simply do not specify any assignments.', 'helper' ); ?></p>
