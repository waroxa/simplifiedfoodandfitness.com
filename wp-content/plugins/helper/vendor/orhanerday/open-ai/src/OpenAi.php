...
class OpenAi
{
     ...
     * @return bool|string
     */
    public function listAssistants($query = [], $api_version = 'v1')
    {
        $this->headers[] = 'OpenAI-Beta: assistants=' . $api_version;
        $url = Url::assistantsUrl();
        if (count($query) > 0) {
     ...
     * @return bool|string
     */
    public function createThread($data = [], $api_version = 'v1')
    {
        $this->headers[] = 'OpenAI-Beta: assistants=' . $api_version;
        $url = Url::threadsUrl();
        $this->baseUrl($url);
     ...
     * @return bool|string
     */
    public function deleteThread($threadId, $api_version = 'v1')
    {
        $this->headers[] = 'OpenAI-Beta: assistants=' . $api_version;
        $url = Url::threadsUrl() . '/' . $threadId;
        $this->baseUrl($url);
     ...
     * @return bool|string
     */
    public function createThreadMessage($threadId, $data, $api_version = 'v1')
    {
        $this->headers[] = 'OpenAI-Beta: assistants=' . $api_version;
     ...
     * @return bool|string
     */
    public function listThreadMessages($threadId, $query = [], $api_version = 'v1')
    {
        $this->headers[] = 'OpenAI-Beta: assistants=' . $api_version;
        $url = Url::threadsUrl() . '/' . $threadId . '/messages';
        if (count($query) > 0) {
     ...
     * @return bool|string
     */
    public function createRun($threadId, $data, $api_version = 'v1')
    {
        $this->headers[] = 'OpenAI-Beta: assistants=' . $api_version;
     ...
     * @return bool|string
     */
    public function retrieveRun($threadId, $runId, $api_version = 'v1')
    {
        $this->headers[] = 'OpenAI-Beta: assistants=' . $api_version;
