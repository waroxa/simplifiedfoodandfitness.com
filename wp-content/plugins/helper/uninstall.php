...
use Merkulove\Helper\Unity\Cache;
use Merkulove\Helper\Unity\Helper;
use Merkulove\Helper\Unity\Plugin;
use Merkulove\Helper\UninstallHelper;
...
final class Uninstall {
    ...
    public function get_uninstall_mode() {
        ...
        if ( isset( $uninstall_settings[ 'mdp_helper_migration_settings' ] ) && $uninstall_settings[ 'mdp_helper_migration_settings' ] ) { // Default value.
            $uninstall_settings = [
